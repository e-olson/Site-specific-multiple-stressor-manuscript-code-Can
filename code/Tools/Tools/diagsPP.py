...
scenNameDict={('ESM4_historical_D1','ESM4_ssp245_D1_histCont'):'GFDL-ESM4.1.1975_2022',
...
# derived file names
def extractedTSPath(iscen,dsid,jj,ii,qualifier='_1x1grid',basepath='/work/Elise.Olson/calcs/extracted_OAPBuoy/'):
    scenName=scenNameDict[iscen]
    return basepath+f"{scenName}/{scenName}.{dsid}.j{jj}i{ii}{qualifier}.nc"

def searchExtracted(iscen,dsid,qualifier='_1x1grid',basepath='/work/Elise.Olson/calcs/extracted_OAPBuoy/'):
